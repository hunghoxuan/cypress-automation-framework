...
--
  ...
  begin
    ...
    loop
      ...
      loop
        ...
        r_acct.ACCT_NUMBER                         :=   '21111111'                  ;
        r_acct.STATEMENT_TYPE                      :=   '068'                       ;
  ...
  begin
	...
	r_appl.LAST_NAME                          :=  'Gates';
	r_appl.FIRST_NAME                         :=  'Bill';
...
---Finfarma Merchants-----
createApplication(p_client_number => '00000044', p_group_client=> '00000050',      p_parent_client => '',      p_client_level =>  '001',      p_business_class =>  '4816',      p_posting_method =>  '001',      p_condition_set =>  '000005',      p_client_type =>  '002',      p_addr_category => '001',      p_billing_level => '001',      p_account_type => '050,051,052,053,055,056,060,061',      p_acct_currency => '986',      p_service_contract_id => '101',      p_service_id => '102,200,201,300,301,302,303,304,306,307,308,309,310,312,716',       p_tran_tariff => '000001'
      ); --TestCase       A"
createApplication(p_client_number => '00000045', p_group_client=> '00000051',      p_parent_client => '',      p_client_level =>  '001',      p_business_class =>  '4816',      p_posting_method =>  '001',      p_condition_set =>  '000005',      p_client_type =>  '002',      p_addr_category => '001',      p_billing_level => '001',      p_account_type => '050,051,052,053,055,056,060,061',      p_acct_currency => '986',      p_service_contract_id => '101',      p_service_id => '102,200,201,300,301,302,303,304,306,307,308,309,310,312,716',       p_tran_tariff => '000001'
      ); --TestCase       A"
createApplication(p_client_number => '00000046', p_group_client=> '00000049',      p_parent_client => '',      p_client_level =>  '001',      p_business_class =>  '7311',      p_posting_method =>  '001',      p_condition_set =>  '000005',      p_client_type =>  '002',      p_addr_category => '001',      p_billing_level => '001',      p_account_type => '050,051,052,053,055,056,060,061',      p_acct_currency => '986',      p_service_contract_id => '101',      p_service_id => '102,200,201,300,301,302,303,304,306,307,308,309,310,312,716',       p_tran_tariff => '000001'
      ); --TestCase       A"
createApplication(p_client_number => '00000047', p_group_client=> '00000052',      p_parent_client => '',      p_client_level =>  '001',      p_business_class =>  '4816',      p_posting_method =>  '001',      p_condition_set =>  '000005',      p_client_type =>  '002',      p_addr_category => '001',      p_billing_level => '001',      p_account_type => '050,051,052,053,055,056,060,061',      p_acct_currency => '986',      p_service_contract_id => '101',      p_service_id => '102,200,201,300,301,302,303,304,306,307,308,309,310,312,716',       p_tran_tariff => '000001'
      ); --TestCase       A"
